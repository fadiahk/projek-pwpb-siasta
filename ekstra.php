...
<body>
          ...
          <div id='tabs'>
            <section class='tabs-content'>
              <article id='tabs-1'>
                <div class="row">
                  <div class="col-md-8">
                    <h4>Ekstrakulikuler Asta Arkananta</h4>
  ...
  <section class=" courses" data-section="section4">
    <div class="container-fluid">
      <div class="row">
        <div class="owl-carousel owl-theme">
          ...
          <?php
          $no = 1;
          $ekstra = mysqli_query($koneksi, "SELECT * FROM ekstra INNER JOIN user on ekstra.id_user = user.id_user;");
          if (mysqli_num_rows($ekstra) > 0) {
            while ($item = mysqli_fetch_array($ekstra)) {
          ?>
              <div class="item">
                <?php
                if ($item['img_ekstra'] != null || $item['img_ekstra'] != '-') {
                ?>
                  <img src="user/uploads/ekstra/<?php echo $item['img_ekstra']; ?>" alt="Course #<?php echo $no++; ?>">
                <?php
                }
                ?>
                <div class="down-content">
                  <h4><?= $item['nama_ekstra']; ?></h4>
                  <p><?= $item['desc_ekstra']; ?></p>
                  <div class="author-image">
                    <?php
                    if ($item['img_user'] != null || $item['img_user'] != '-') {
                    ?>
                      <img src="user/uploadsuser/<?php echo $item['img_user']; ?>" alt="Author <?php echo $item['id_user']; ?>" style="width: 10%;">
                    <?php
                    }
                    ?>
                  </div>
