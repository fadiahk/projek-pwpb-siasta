          ...
          <div id='tabs'>
            <section class='tabs-content'>
              <article id='tabs-1'>
                <div class="row">
                  <div class="col-md-8">
                    <h4>Product Student</h4>
                    <p>Place marketing atau pemasaran tempat adalah kegiatan pemasaran yang diarahkan untuk menciptakan sikap atau kesan yang menguntungkan dari wilayah geografis tertentu contohnya ada pada wilayah sekolah ini. Tujuannya adalah untuk menarik warga Asta agar mengetahui Produk siswa Asta</p>
                  </div>
                </div>
              </article>
            </section>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="owl-carousel owl-theme">
          ...
          <?php
          $no = 1;
          $produk = mysqli_query($koneksi, "SELECT * FROM produk INNER JOIN user on produk.id_user = user.id_user;");
          if (mysqli_num_rows($produk) > 0) {
            while ($item = mysqli_fetch_array($produk)) {
          ?>
              <div class="item">
                <?php
                if ($item['img_produk'] != null || $item['img_produk'] != '-') {
                ?>
                  <img src="user/uploadsproduk/<?php echo $item['img_produk']; ?>" alt="Course #<?php echo $no++; ?>">
                <?php
                }
                ?>
