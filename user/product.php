...
if (isset($_POST['edit_produk'])) {
  ...
  if (!empty($filename)) {
    ...
    move_uploaded_file($_FILES['foto']['tmp_name'], 'uploadsproduk/' . $filenm);
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="?page=tambah_produk" class="btn btn-primary" id="btn_tambah" name="btn_tambah">Tambah</a>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM produk INNER JOIN user ON produk.id_user = user.id_user where produk.id_user=$user ;");
                ...
                ?>
                    <tr>
                      <td><?php echo $no++; ?></td>
                      <td><img src="uploadsproduk/<?php echo $data['img_produk']; ?>" width="50" height="50"> </td>
                        ...
                        <div class="modal-content bg-success">
                          ...
                          <form action="product.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="nama_produk" value="<?= $data['nama_produk'] ?>" name="nama_produk" placeholder="Nama produk ">
                            </div>
                            <div class="modal-body">
                              ...
                              <div class="form-group">
                                ...
                                <textarea name="desc_produk" class="form-control" id="desc_produk" placeholder="desc_produk" cols="30" rows="8"><?= $data['desc_produk'] ?></textarea>
                              </div>
                              <div class="form-group">
                                <label for="exampleInputPassword1">Nama Toko </label>
                                <input type="text" class="form-control" id="toko" value="<?= $data['toko'] ?>" name="toko" placeholder="toko">
                              </div>
                            </div>
